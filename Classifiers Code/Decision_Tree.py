# ======================================================
#  Decision Tree  (Lever-2-ish) – full workflow
...
# ---------- Decision-Tree model (Lever-2 style limits) ----------
tree = DecisionTreeClassifier(
    criterion='gini',
    max_depth=8,            # keep it modest to avoid spaghetti
    min_samples_split=25,   # ≈ gamma & min_child_weight vibe
    min_samples_leaf=15,
...
# ---------- Go! ----------
full_report(tree, 'Decision Tree ')
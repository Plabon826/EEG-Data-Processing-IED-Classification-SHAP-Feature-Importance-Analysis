...
# ---------- SVM model ----------
svm = SVC(
    kernel='rbf',           # Radial Basis Function kernel (can be changed to linear, poly, etc.)
    C=1.0,                  # Regularization parameter
    gamma='scale',          # Kernel coefficient (use 'scale' for automatic scaling)
    random_state=42
)
...
# ---------- 4-way reporter ----------
def full_report(model, label='SVM'):
    datasets = {

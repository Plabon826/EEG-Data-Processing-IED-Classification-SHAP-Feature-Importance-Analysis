# ======================================================
#  Linear Discriminant Analysis – full workflow
...
# ---------- LDA model ----------
lda = LDA(            # default solver='svd' is numeric-stable & quick
    shrinkage=None,   # set to 'auto' or float if singularities appear
    solver='svd'      # 'lsqr'/'eigen' also work; 'svd' ignores shrinkage
)
